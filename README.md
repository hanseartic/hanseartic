# Hi there, I'm hanseartic 👋

## 🚀 About Me

I'm a versatile software developer with a passion for blockchain technology and open source contributions. My work spans across multiple domains, from IoT and cloud infrastructure to blockchain development, with a particular focus on the **Stellar ecosystem**.
...
- 🤖 **DevOps**: GitHub Actions, CI/CD, Docker, Portainer
- 🛠️ **Tools**: Node.js, npm, TypeScript, Rust toolchain
...
- 🌐 GitHub: [@hanseartic](https://github.com/hanseartic)
- 🌟 Check out my [Stellar projects](https://github.com/hanseartic?tab=repositories&q=stellar)
- 💼 Open to collaboration on blockchain and open source projects!

---

*"Contributing to open source, one commit at a time, with a special focus on making blockchain technology more accessible."*
